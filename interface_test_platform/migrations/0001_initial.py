# Generated by Django 2.2.4 on 2022-03-24 19:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_suite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.CaseSuite', verbose_name='测试集合')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_module', smart_selects.db_fields.GroupedForeignKey(group_field='belong_project', on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.Module', verbose_name='所属模块')),
                ('belong_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.Project', verbose_name='所属项目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, null=True, verbose_name='更新时间')),
                ('belong_test_case', smart_selects.db_fields.GroupedForeignKey(group_field='belong_test_case', on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.TestCase', verbose_name='所属用例')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now=True, verbose_name='创建时间')),
                ('case_suite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.CaseSuite', verbose_name='用例集合')),
                ('test_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.TestCase', verbose_name='测试用例')),
            ],
        ),
        migrations.AddField(
            model_name='module',
            name='belong_project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.Project'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('execute_start_time', models.CharField(blank=True, max_length=300, null=True, verbose_name='执行开始时间')),
                ('execute_end_time', models.CharField(blank=True, max_length=300, null=True, verbose_name='执行结束时间')),
                ('case_suite_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.CaseSuiteExecuteRecord', verbose_name='测试集合执行记录')),
                ('test_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interface_test_platform.TestCase', verbose_name='测试用例')),
            ],
        ),
    ]
